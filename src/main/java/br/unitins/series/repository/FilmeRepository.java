...
public class FilmeRepository extends Repository<Filme>{
	...
	public List<Filme> findByTitulo(String titulo) throws RepositoryException {
		try { 
			EntityManager em = getEntityManager();
			//JPQL ou SQL
			Query query = em.createQuery("SELECT u FROM Filme u WHERE upper(u.titulo) LIKE upper(:titulo)");
			...
			throw new RepositoryException("Problema ao pesquisar filmes.");
		}
	}

...
@WebServlet("/img-serie")
public class ImgSerieServlet extends HttpServlet {
	...
	// /images/serie
	public static final String PATH_IMAGES_SERIE = PATH_IMAGES + File.separator + "serie";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // /home/janio/images/serie/
        String diretorio = System.getProperty("user.home") + File.separator + PATH_IMAGES_SERIE + File.separator;
        
        // montando a imagem com e endereco do servidor
        // /home/janio/images/serie/2.png
